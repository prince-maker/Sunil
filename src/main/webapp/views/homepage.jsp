    ...
    <div class="container">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li style="color:blue;"><a href="#about">About</a></li>
     ...
     <!--   <div class="slinks">  
       <li class="list-inline-item"><a href="http://api.whatsapp.com/send?phone=918892955017"class="fa fa-whatsapp" ></i></a></li>
        <li class="list-inline-item"><a href="http://www.facebook.com/" class="fa fa-facebook"></i></a></li>
      ...
      <div class="row">
        ...
        <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
          ...
          <p class="font-italic">
            ...
            applications as per the client requirements.
          </p>
          <div class="row">
            <div class="col-lg-6">
              <ul>
    ...
    <div class="skills container">
      ...
      <div class="row skills-content">
        ...
        <div class="col-lg-6">
          ...
          <div class="progress">
            <span class="skill">java Script <i class="val">80%</i></span>
            <div class="progress-bar-wrap">
          ...
          <div class="progress">
            <span class="skill">hibernate <i class="val">90%</i></span>
            <div class="progress-bar-wrap">
    ...
    <div class="interests container">
      ...
      <div class="row">
        <div class="col-lg-3 col-md-4">
          <div class="icon-box">
            <i class="ri-dribbble-line" style="color: #ffbb2c;"></i>
            <h3>Cricket</h3>
          </div>
        </div>
        <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
          <div class="icon-box">
            <i class="ri-dribbble-line" style="color: #5578ff;"></i>
            <h3>Vollyball</h3>
          </div>
        </div>
        <div class="col-lg-3 col-md-4 mt-4 mt-md-0">
          <div class="icon-box">
            <i class="ri-macbook-line" style="color: #e80368;"></i>
            <h3>Coding</h3>
          </div>
        </div>
        <div class="col-lg-3 col-md-4 mt-4 mt-lg-0">
          <div class="icon-box">
            <i class="ri-heart-fill" style="color: #e361ff;"></i>
            <h3>Dance</h3>
          </div>
        </div>
        <div class="col-lg-3 col-md-4 mt-4">
          <div class="icon-box">
            <i class="ri-disc-line" style="color: #47aeff;"></i>
            <h3>Indian music</h3>
          </div>
        </div>
        <div class="col-lg-3 col-md-4 mt-4">
          <div class="icon-box">
            <i class="ri-flight-takeoff-fill" style="color: #ffa76e;"></i>
            <h3>Traveling</h3>
          </div>
        </div>
        <div class="col-lg-3 col-md-4 mt-4">
          <div class="icon-box">
            <i class="ri-user-shared-2-line" style="color: #11dbcf;"></i>
            <h3>Teaching</h3>
          </div>
        </div>
        <div class="col-lg-3 col-md-4 mt-4">
          <div class="icon-box">
            <i class="ri-open-arm-line" style="color: #4233ff;"></i>
            <h3>Learning new things</h3>
          </div>
        </div>
        <div class="col-lg-3 col-md-4 mt-4">
          <div class="icon-box">
            <i class="ri-health-book-fill" style="color: #b2904f;"></i>
            <h3>Reading</h3>
          </div>
        </div>
